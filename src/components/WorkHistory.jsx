...
const experiences = [
    {
        ...
        type: "Part-time",
        description: "Working on various projects and learning new technologies in Data Center Management. Collaborating with cross-functional teams to optimize data flows.",
        icon: FaBriefcase,
        tags: ["Data Center", "Management", "Cloud"],
    },
    {
        id: 2,
        ...
        type: "Full-time",
        description: "Responsible for maintaining and troubleshooting the IT infrastructure. Implemented network security protocols and optimized system performance.",
        icon: FaCode,
